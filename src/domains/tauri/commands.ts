...
// New message-based output (new architecture)
...
export async function getAgentMessagesCount(agentId: string): Promise<number> {
  return invoke("get_agent_messages_count", { agentId });
}
